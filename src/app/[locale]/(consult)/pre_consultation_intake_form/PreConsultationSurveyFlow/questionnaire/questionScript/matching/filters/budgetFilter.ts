import { Candidate, PriorityId, Substitution, ExcludedItem, TreatmentKey } from '@/app/[locale]/(consult)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
...
import { META, LIFTING_ORDER, TEXTURE_STRONG, TEXTURE_GENTLE } from '@/app/[locale]/(consult)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/constants/treatmentMeta';
