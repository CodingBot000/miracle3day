...
import { BottomTabBar } from '@/app/(site)/mobile/components/ui/BottomTabBar';
import { RoutineScreen } from '@/app/(site)/mobile/screens/Routine/RoutineScreen';
import { PlaceholderScreen } from '@/app/(site)/mobile/screens/Placeholder/PlaceholderScreen';
import { SafeAreaContainer } from '@/app/(site)/mobile/components/ui/SafeAreaContainer';
