import { ConcernId, TreatmentGoalId, PastId } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/types';
import {
  CONCERN_ID_EXPANSIONS,
  GOAL_ID_EXPANSIONS,
  PAST_TREATMENT_MAPPING
} from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/constants/mappings';
