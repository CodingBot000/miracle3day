import { AgeGroup, AgeGroupLegacy, Gender, Candidate, TreatmentKey } from '@/app/(consult)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/types';
