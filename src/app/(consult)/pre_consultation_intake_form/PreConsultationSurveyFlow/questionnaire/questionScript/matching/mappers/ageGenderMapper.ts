import { AgeGroup, Gender, Candidate, TreatmentKey } from '@/app/(consult)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
