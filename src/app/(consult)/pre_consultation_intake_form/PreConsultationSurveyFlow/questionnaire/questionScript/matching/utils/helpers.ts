import { TreatmentKey, Candidate, AreaId, RecommendedItem } from '@/app/(consult)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
