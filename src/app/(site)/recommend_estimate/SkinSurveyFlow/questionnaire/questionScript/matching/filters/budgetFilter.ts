import { Candidate, PriorityId, Substitution, ExcludedItem, TreatmentKey } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/types';
import { PRICE_TABLE } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/constants/prices';
import { META, LIFTING_ORDER, TEXTURE_STRONG, TEXTURE_GENTLE } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/constants/treatmentMeta';
