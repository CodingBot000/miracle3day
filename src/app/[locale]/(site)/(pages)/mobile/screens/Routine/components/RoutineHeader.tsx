...
import { getStepDefinitions } from '@/app/[locale]/(site)/(pages)/mobile/state/routineMockData';
import { ProgressRing } from './ProgressRing';
import { formatKoreanDateLabel } from '@/app/[locale]/(site)/(pages)/mobile/lib/dateHelpers';
