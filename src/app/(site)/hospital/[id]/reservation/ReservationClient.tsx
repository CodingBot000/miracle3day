...
import ReservationCalendarClient from '@/app/(site)/hospital/[id]/components/content/ReservationCalendarClient';
import HospitalListCard from '@/app/(site)/hospital/components/HospitalListCard';
