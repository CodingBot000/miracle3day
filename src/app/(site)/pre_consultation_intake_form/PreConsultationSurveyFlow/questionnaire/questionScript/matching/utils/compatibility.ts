import { ConcernId, TreatmentGoalId, PastId } from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
import {
  CONCERN_ID_EXPANSIONS,
  GOAL_ID_EXPANSIONS,
  PAST_TREATMENT_MAPPING
} from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/constants/mappings';
