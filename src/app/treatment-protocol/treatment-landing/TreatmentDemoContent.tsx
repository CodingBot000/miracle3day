...
import CompareModal from "./_demo/CompareModal";
import CategorySection from "./_demo/CategorySection";
import CategoryGridCard from "./_demo/CategoryGridCard";
import useCompareSelection from "./_demo/useCompareSelection";
import { sortTreatments, matchScore } from "./_demo/utils-search-sort";
import BookingForm from "./_demo/BookingForm";
import ContactForm from "./_demo/ContactForm";
        ...
        {categories.map((cat, index) => (
          <CategoryGridCard
            ...
            onClick={(category) => {
              ...
              router.push(`/treatment-landing/treatment-list?${params.toString()}`);
            }}
          />
        ))}
      </div>
