...
\n
2. Visit BeautyLink Platform, Making Reservations, Rentals, and/or Bookings, and/or International Shopping for the Services or Using the Services:
\n
When you visit BeautyLink Platform (even you have not registered an User Account or logged in), make reservations, rentals, and/or bookings for any intended Services or use the Services, we may collect and process certain information (which may contain your Personal Information or may contain non-personally identifiable information but nevertheless linked to your Personal Information) including but not limited to those set out below. The information will be stored until you withdraw your BeautyLink account (Will be abided by the law)
\n
...
\n
3. Details of your usage of BeautyLink Platform (including traffic data, location data and length of user sessions);
\n
4. Feedback on and responses to surveys conducted by BeautyLink relating to the Services and newsletters which may be published, circulated or distributed by BeautyLink;
\n
5. Information automatically collected and stored in our server or the server of our third party services provider by using or accessing to BeautyLink Platform (including the log-in name and password for your User Account, your computers Internet Protocol (IP) address, browser type, browser information, device information (including unique device identifier), pages visited, previous or subsequent sites visited).
\n
6. When you use your mobile devices to visit BeautyLink Platform, we may collect information about you and your mobile device as stated above. This can include location information if you have consented and configured your mobile device to send us such information or upload photos with location information to BeautyLink Platform. Such location information will be used in the ways and for the purposes as stated in this Privacy Policy. For example, we may use your location to suggest nearby Services during your travel or provide personalized content. You can change your mobile device’s privacy settings at any time to deactivate the function of sharing location information. Please note some features of BeautyLink Platform may be affected if you turn off such location sharing function. Should you have any enquiries about your mobile devices’ privacy settings, we recommend you contacting your mobile services provider or the manufacturer of your device.
\n
If you make reservations, rentals, and/or bookings and/of purchase for other individuals through the BeautyLink Platform, we may request personal information about such individual. You must obtain all requisite consent of such individuals and ensure they are aware of, understand and accept this Privacy Policy prior to providing their personal data to BeautyLink.
\n\n
...
\n
3. BeautyLink will use reasonable endeavours to maintain appropriate physical, electronic and organisational procedures to ensure that your Personal Information and other data is treated securely and in accordance with this Privacy Policy, and to protect such data against unauthorized access or unauthorized alteration, disclosure or destruction of data.
\n
4. Once we have received your information, we will use strict procedures and security features to try to prevent unauthorized access. BeautyLink does not give any representation, warranty or undertaking that the Personal Information you provide to us will be secure at all times, and to the extent BeautyLink has fulfilled its obligations under no circumstances shall BeautyLink be responsible for any losses, damages, costs and expenses which you may suffer or incur arising from unauthorised access to or use of your Personal Information.
\n
...
\n
2. For example, BeautyLink will use Personal Information and other data collected through BeautyLink Platform or when making purchases for the Services to create your User Account, to fulfil your reservations, rentals, and/or bookings for the Services, to provide you with the Services, to continually improve BeautyLink Platform and the Services, and to contact you in relation to the Services. This includes using your Personal Information or such other data to achieve faster purchase requests, better customer support and to provide you with timely notice of new Services and special offers.
\n
3. From time to time, we may also make use of your Personal Information to contact you for feedback on your use of BeautyLink Platform, to assist us in improving BeautyLink Platform, or to offer special savings or promotions to you, where you have indicated your consent to receiving such communications. If you would prefer not to receive notices of special savings or promotions, you may simply opt-out from receiving them by replying to us through the hyperlink provided in these notices.
\n\n
...
\n
6. Within the BeautyLink group of companies. In case of a corporate transaction, in connection with the sale, merger, acquisition, or other corporate reorganization or restructuring of our corporation, your Personal Information may be disclosed, shared or transferred to the new controlling entity or its authorized third party for carrying on our business.
\n
7. To our advisors, agencies or other parties concerned in order to protect the rights and property of BeautyLink.
\n
...
\n
9. Any reviews that you post on BeautyLink will be considered for use as content for marketing purposes by BeautyLink.
\n
...
\n
There may be links present on BeautyLink Platform which could result in you leaving BeautyLink Platform and/or being taken to other third party websites. You should note that any Personal Information that you provide to these third party websites are not subject to this Privacy Policy, and BeautyLink is not liable for any losses, damages, costs or expenses which you may suffer or incur in connection with you providing or making available Personal Information or other data to such third party websites.
\n\n
INSURANCE
\n
...
COOKIES
\n
Cookies are widely used in order to make websites work, or work more efficiently. When you visit our Website, we collect some of your Personal Information transmitted to us by your browser via cookies. This enables you to access BeautyLink Platform and helps us to create better user experience for you.
\n
YOUR RIGHTS
\n
You may at all times access, correct or erase your Personal Information through BeautyLink Platform via the user portal, under “My Account”. Alternatively, you may make your data access, correction or erasure request by sending your request by email at 3daymiracle0@gmail.com
\n
Where mandatory under applicable legislation, you may also request restriction of processing of your Personal Information or object to processing by sending your request or objection by email at help@BeautyLink.com. You may also request a copy of the information that we hold about you by sending your request by email at 3daymiracle0@gmail.com
\n
