...
export default function KBeautySectionPage({ params }: Props) {
  ...
  // log.debug('=== K-Beauty Image Debug ===');
  // log.debug('Section id:', section.id);
  // log.debug('Section Key:', sectionKey);
  // log.debug('Section Number:', sectionNumber);
  // log.debug('Background Image Path:', backgroundImagePath);
  // log.debug('Section Title:', section.title);
