import { TreatmentKey, Candidate, AreaId, RecommendedItem } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/types';
import { META } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/constants/treatmentMeta';
