...
import { BottomTabBar } from '@/app/[locale]/(site)/(pages)/mobile/components/ui/BottomTabBar';
import { RoutineScreen } from '@/app/[locale]/(site)/(pages)/mobile/screens/Routine/RoutineScreen';
import { PlaceholderScreen } from '@/app/[locale]/(site)/(pages)/mobile/screens/Placeholder/PlaceholderScreen';
import { SafeAreaContainer } from '@/app/[locale]/(site)/(pages)/mobile/components/ui/SafeAreaContainer';
