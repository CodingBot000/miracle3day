...
//     intro: {
//       title: "INTRO",
//       content: ` BeautyWell ('BeautyWell', 'we', 'us', 'our') are committed to protecting and respecting your personal data privacy and complying with data protection principles and provisions under applicable laws.
// We may collect, process, use and disclose your information when you use this website www.BeautyWell.com and/or the BeautyWell App (together, 'BeautyWell Platform') and the services offered by BeautyWell or the third party operators (the 'Operators') through BeautyWell Platform (the 'Services') as described in this Privacy Policy. 'You' and 'your' when used in this Privacy Policy includes any person who accesses BeautyWell Platform or use the Services.
// This Privacy Policy sets out the basis and terms upon which BeautyWell collects, processes, uses and/or discloses your information that is obtained from you when you access BeautyWell Platform and/or use the Services. Such information may include personal information relating to or linked to a specific individual such as name, residential address, telephone number, email address, travel document information, vehicle rental information, insurance information, age, date of birth, or any such information we have requested and you have provided through BeautyWell Platform ('Personal Information').
// Please read this Privacy Policy carefully. By visiting BeautyWell Platform, you are consenting to the collection, processing, usage and disclosure of your Personal Information as set out in this Privacy Policy.
// `},
  
//     scopeOfTerms: {
//       title: "SCOPE OF TERMS",
//       content: `BeautyWell reserves the right to update, amend or modify the terms of this Privacy Policy or any part of it without prior notice, and your continued access of BeautyWell Platform or use of the Services signifies your acceptance of the updated, amended or modified Privacy Policy, unless if the changes reduce your rights in which case we will ask for your consent. If you do not agree to all the terms and conditions in this Privacy Policy and/or any subsequent updates, amendments or modifications thereto, you must stop accessing or otherwise using BeautyWell Platform and the Services.
// Accordingly, please visit this page if you wish to access and view the current version of this Privacy Policy.
// `},
  
//     collectionOfInfo: {
//       title: "COLLECTION OF INFO",
//       content: `We may collect Personal Information about you that you provide to us while using BeautyWell Platform and information about how you use BeautyWell Platform including when you open your user account ('User Account'), visit BeautyWell Platform or make reservations, rentals and/or bookings or international shopping for any intended Services or using the Services. Providing your Personal Information to BeautyWell is always on a voluntary basis. However, we might not be able to provide you with certain Services if you choose not to give us your Personal Information. For example, we cannot open your user account or make reservations, rentals and/or bookings for you if we do not collect your name and contact details. For another example, we cannot ship products from Republic of Korea without your personal custom number.
...
// 2. Visit BeautyWell Platform, Making Reservations, Rentals, and/or Bookings, and/or International Shopping for the Services or Using the Services:
// When you visit BeautyWell Platform (even you have not registered an User Account or logged in), make reservations, rentals, and/or bookings for any intended Services or use the Services, we may collect and process certain information (which may contain your Personal Information or may contain non-personally identifiable information but nevertheless linked to your Personal Information) including but not limited to those set out below. The information will be stored until you withdraw your BeautyWell account (Will be abided by the law)
...
// 3. BeautyWell will use reasonable endeavours to maintain appropriate physical, electronic and organisational procedures to ensure that your Personal Information and other data is treated securely and in accordance with this Privacy Policy, and to protect such data against unauthorized access or unauthorized alteration, disclosure or destruction of data.
// 4. Once we have received your information, we will use strict procedures and security features to try to prevent unauthorized access. BeautyWell does not give any representation, warranty or undertaking that the Personal Information you provide to us will be secure at all times, and to the extent BeautyWell has fulfilled its obligations under no circumstances shall BeautyWell be responsible for any losses, damages, costs and expenses which you may suffer or incur arising from unauthorised access to or use of your Personal Information.
...
//     usageOfInfo: {
//       title: "USAGE OF INFO",
//       content: `1. We process the Personal Information collected in as far as necessary for performance of the contract with and providing services to you. Besides, we process the other Personal Information collected on the basis of our legitimate interests, which are the further improvement of the services and for direct marketing purposes.
// 2. For example, BeautyWell will use Personal Information and other data collected through BeautyWell Platform or when making purchases for the Services to create your User Account, to fulfil your reservations, rentals, and/or bookings for the Services, to provide you with the Services, to continually improve BeautyWell Platform and the Services, and to contact you in relation to the Services. This includes using your Personal Information or such other data to achieve faster purchase requests, better customer support and to provide you with timely notice of new Services and special offers.
// 3. From time to time, we may also make use of your Personal Information to contact you for feedback on your use of BeautyWell Platform, to assist us in improving BeautyWell Platform, or to offer special savings or promotions to you, where you have indicated your consent to receiving such communications. If you would prefer not to receive notices of special savings or promotions, you may simply opt-out from receiving them by replying to us through the hyperlink provided in these notices.
// `},
  
//     disclosureOfInfo: {
//       title: "DISCLOSURE OF INFO",
//      content: `We may from time to time share and disclose your Personal Information and other data to third parties, some of whom may be located outside your home country. The circumstances under which such sharing and disclosure will take place may include without limitation, the following:
...
// 6. Within the BeautyWell group of companies. In case of a corporate transaction, in connection with the sale, merger, acquisition, or other corporate reorganization or restructuring of our corporation, your Personal Information may be disclosed, shared or transferred to the new controlling entity or its authorized third party for carrying on our business.
// 7. To our advisors, agencies or other parties concerned in order to protect the rights and property of BeautyWell.
...
// 9. Any reviews that you post on BeautyWell will be considered for use as content for marketing purposes by BeautyWell.
...
// There may be links present on BeautyWell Platform which could result in you leaving BeautyWell Platform and/or being taken to other third party websites. You should note that any Personal Information that you provide to these third party websites are not subject to this Privacy Policy, and BeautyWell is not liable for any losses, damages, costs or expenses which you may suffer or incur in connection with you providing or making available Personal Information or other data to such third party websites
// `},
  
//     insurance: {
//       title: "INSURANCE",
//       content: `You need to agree to a separate group agreement when you sign up for insurance services.
//       `},

//     cookies: {
//       title: "COOKIES",
//       content: `Cookies are widely used in order to make websites work, or work more efficiently. When you visit our Website, we collect some of your Personal Information transmitted to us by your browser via cookies. This enables you to access BeautyWell Platform and helps us to create better user experience for you.
//       `},
  
//     yourRights: {
//      title: "YOUR RIGHTS",
//      content: `You may at all times access, correct or erase your Personal Information through BeautyWell Platform via the user portal, under “My Account”. Alternatively, you may make your data access, correction or erasure request by sending your request by email at mimotok.official@gmail.com.
// Where mandatory under applicable legislation, you may also request restriction of processing of your Personal Information or object to processing by sending your request or objection by email at mimotok.official@gmail.com. You may also request a copy of the information that we hold about you by sending your request by email at mimotok.official@gmail.com.
...
//     inquiries: {
//       title: "INQUIRIES",
//       content: `If you have any questions about this Privacy Policy, please contact us by email at mimotok.official@gmail.com`
//     },
//   };
