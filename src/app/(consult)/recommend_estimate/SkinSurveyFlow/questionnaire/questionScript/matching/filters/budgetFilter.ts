import { Candidate, PriorityId, Substitution, ExcludedItem, TreatmentKey } from '@/app/(consult)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/types';
import { PRICE_TABLE } from '@/app/(consult)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/constants/prices';
import { META, LIFTING_ORDER, TEXTURE_STRONG, TEXTURE_GENTLE } from '@/app/(consult)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/constants/treatmentMeta';
