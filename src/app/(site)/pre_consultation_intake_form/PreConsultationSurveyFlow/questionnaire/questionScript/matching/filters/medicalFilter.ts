import { Candidate, MedicalId, ExcludedItem } from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
import { isInjectable, createsWound } from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/utils/helpers';
