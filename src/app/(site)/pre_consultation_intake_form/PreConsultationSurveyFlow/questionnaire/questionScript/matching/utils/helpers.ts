import { TreatmentKey, Candidate, AreaId, RecommendedItem } from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
