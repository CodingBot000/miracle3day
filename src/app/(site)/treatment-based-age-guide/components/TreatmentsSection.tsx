...
import { krwToUsd } from '@/app/(consult)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/utils/helpers';
    ...
    <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 md:p-8 shadow-sm border border-white/30">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {treatments.map((treatment) => {
          const formattedCost = formatTreatmentCost(treatment, language);
              ...
              <div className="p-6">
                ...
                {treatment.cycle && (
                  <div className="flex items-start gap-2 text-sm text-gray-600">
                    ...
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].cycle}:</span>
                ...
                {treatment.interval && (
                  <div className="flex items-start gap-2 text-sm text-gray-600">
                    <Calendar className="w-4 h-4 flex-shrink-0 mt-0.5" />
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].interval}:</span>
                ...
                {treatment.duration && (
                  <div className="flex items-start gap-2 text-sm text-gray-600">
                    ...
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].duration}:</span>
                ...
                {treatment.time && (
                  <div className="flex items-start gap-2 text-sm text-gray-600">
                    ...
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].time}:</span>
                ...
                {formattedCost && (
                  <div className="flex items-start gap-2 text-sm text-gray-600">
                    ...
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].cost}:</span>
                ...
                {treatment.onset && (
                  <div className="flex items-start gap-2 text-xs text-purple-600 bg-purple-50 px-2 py-1 rounded">
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].onset}:</span>
                ...
                {treatment.downtime && (
                  <div className="flex items-start gap-2 text-xs text-orange-600 bg-orange-50 px-2 py-1 rounded">
                    <span className="font-medium w-20 flex-shrink-0">{labels[language].downtime}:</span>
