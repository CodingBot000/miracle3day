import { TreatmentGoalId, Candidate } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/types';
import { expandGoalId } from '@/app/(site)/recommend_estimate/SkinSurveyFlow/questionnaire/questionScript/matching/utils/compatibility';
