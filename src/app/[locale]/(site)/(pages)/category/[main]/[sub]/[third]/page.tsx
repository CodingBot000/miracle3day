...
import { SKIN_BEAUTY_CATEGORIES } from "@/app/[locale]/(site)/(pages)/contents/category/skinBeautyCategories";
...
import CategoryEventProductList from "@/app/[locale]/(site)/(pages)/category/component/CategoryEventProductList";
