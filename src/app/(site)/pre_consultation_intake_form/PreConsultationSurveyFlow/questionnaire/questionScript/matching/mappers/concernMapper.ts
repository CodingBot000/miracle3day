import { SelectedConcern, Candidate, ConcernId } from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/types';
import { expandConcernId } from '@/app/(site)/pre_consultation_intake_form/PreConsultationSurveyFlow/questionnaire/questionScript/matching/utils/compatibility';
