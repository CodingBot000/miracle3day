    ...
    <>
      ...
      <div className="fixed bottom-[100px] right-5 z-40">
        <div className="flex flex-col gap-1.5 bg-white/95 backdrop-blur-sm shadow-lg rounded-lg p-2 w-28">
          ...
          >
            {isCreatingChat ? (
              ...
              <>
                ...
                {locale === 'ko' ? labels.ko.chat : labels.en.chat}
              </>
            )}
          </button>
          ...
          >
            {locale === 'ko' ? labels.ko.reservation : labels.en.reservation}
          </button>
          ...
          >
            <Video size={12} />
            {locale === 'ko' ? labels.ko.videoConsultation : labels.en.videoConsultation}
          </button>
        </div>
      </div>
    </>
