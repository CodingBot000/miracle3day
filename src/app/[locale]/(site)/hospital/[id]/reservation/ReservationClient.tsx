...
import ReservationCalendarClient from '@/app/[locale]/(site)/hospital/[id]/components/content/ReservationCalendarClient';
import HospitalListCard from '@/app/[locale]/(site)/hospital/components/HospitalListCard';
