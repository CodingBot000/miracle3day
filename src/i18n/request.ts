...
const messages: Record<string, Record<string, unknown>> = {
  ko: { ...koCommon, ...koHome, ...koWhykbeauty, ...koRecommendTreatment, ...koTreatmentAgedGuide },
  en: { ...enCommon, ...enHome, ...enWhykbeauty, ...enRecommendTreatment, ...enTreatmentAgedGuide },
  ja: { ...jaCommon, ...jaHome, ...jaWhykbeauty, ...enRecommendTreatment, ...jaTreatmentAgedGuide }, // treatment_aged_guide은 en fallback
  'zh-CN': { ...zhCNCommon, ...zhCNHome, ...zhCNWhykbeauty, ...enRecommendTreatment, ...zhCNTreatmentAgedGuide }, // treatment_aged_guide은 en fallback
  'zh-TW': { ...zhTWCommon, ...zhTWHome, ...zhTWWhykbeauty, ...enRecommendTreatment, ...zhTWTreatmentAgedGuide }, // treatment_aged_guide은 en fallback
};
