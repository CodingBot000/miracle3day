...
import TreatmentBasedAgeGuide from "@/app/(site)/treatment-based-age-guide/page";
import TransparentHeaderWrapper from "@/components/layout/TransparentHeaderWrapper";
import QuizPage from "@/app/(site)/gamification/quize/page";
import WhyKoreaButton from "./components/WhyKoreaButton";
import AgeGuideCTA from "@/app/(site)/treatment-based-age-guide/components/AgeGuideCTA";
