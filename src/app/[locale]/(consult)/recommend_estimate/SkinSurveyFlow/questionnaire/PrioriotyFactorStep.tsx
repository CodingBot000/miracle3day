          ...
          <Card key={item.id} className="p-4 bg-white border border-gray-200">
            <div className="flex gap-4">
              <div className="flex-[3] min-w-0 break-words">
                <h3 className="font-medium text-gray-900 mb-1">{getLocalizedText(item.label, locale)}</h3>
                <p className="text-sm text-gray-600 break-words">{getLocalizedText(item.description, locale)}</p>
              </div>
